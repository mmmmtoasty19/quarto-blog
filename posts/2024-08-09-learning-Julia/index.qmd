...
**Authors Note 7/7/2026** This post no longer displays any graphs.  After writing this post the website used to pull data no longer allows me to pull data.  I am leaving it up as it is an interesting journey and the code outside of the particular website is still usable.  **End Note**
